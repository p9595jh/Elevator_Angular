...
var ContentComponent = /** @class */ (function () {
    ...
    ContentComponent.prototype.ngOnInit = function () {
        ...
        this.handleuserService.loggedIn().subscribe(function (data) {
            ...
            _this.http.get(_this.handleuserService.ServerAddress + '/content?type=' + _this.paramType + '&num=' + _this.paramNum, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); })).subscribe(function (result) {
                ...
                _this.audioPath = _this.content.audio;
            });
        });
    };
    ...
    ContentComponent.prototype.onDeleteComment = function (num) {
        var _this = this;
        var formData = {
...
module.exports = "<div class=\"box\">\r\n  <table class=\"admintable\">\r\n    <tr>\r\n      <th>ID</th>\r\n      <th>관리</th>\r\n    </tr>\r\n    <ng-container *ngFor=\"let val of sub?.stops\">\r\n      <tr *ngIf=\"val != sub.id && val != 'admin'\">\r\n        <td><b style=\"cursor:pointer; color:red;\" [attr.id]=\"val\" (click)=\"openInfoWindow(val)\">{{val}}</b></td>\r\n        <td><button (click)=\"onStopUser(val)\" [attr.id]=\"val + 'button'\">해제</button></td>\r\n      </tr>\r\n    </ng-container>\r\n    <ng-container *ngFor=\"let val of clean\">\r\n      <tr *ngIf=\"val != sub.id && val != 'admin'\">\r\n        <td><b style=\"cursor:pointer;\" [attr.id]=\"val\" (click)=\"openInfoWindow(val)\">{{val}}</b></td>\r\n        <td><button (click)=\"onStopUser(val)\" [attr.id]=\"val + 'button'\">정지</button></td>\r\n      </tr>\r\n    </ng-container>\r\n  </table>\r\n</div>\r\n"
...
var SuggestComponent = /** @class */ (function () {
    function SuggestComponent(handleuserService, handleboardService, router, route, flashMessage) {
        var _this = this;
        this.handleuserService = handleuserService;
        this.handleboardService = handleboardService;
        this.router = router;
...
module.exports = __webpack_require__(/*! C:\Users\B107-27\Downloads\Elevator_Angular\angular-src\src\main.ts */"./src/main.ts");
